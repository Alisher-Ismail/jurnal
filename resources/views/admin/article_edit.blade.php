        ...
        <div class="row">
            <div class="col-md-6">
                <form class="form-horizontal" name="material" id="material" method="POST" action="{{ route('article.store') }}" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="vid" value="{{$articl->id}}">
                    <div class="form-group row">
                        <label for="volume" class="col-sm-3 col-form-label">Volume</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$articl->volume}}" name="volume" id="volume" placeholder="Volume">
                        </div>

                        <label for="title" class="col-sm-3 col-form-label">Maqola Nomi</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$articl->title}}" name="title" id="title" placeholder="Maqola Nomi">
                        </div>

                        <label for="keyword" class="col-sm-3 col-form-label">Kalit So`zlar</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$articl->keywords}}" name="keyword" id="keyword" placeholder="Kalit So`zlar">
                        </div>

                        <label for="author" class="col-sm-3 col-form-label">Mualliflar</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" value="{{$articl->author}}" name="author" id="author" placeholder="Mualliflar">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="abstract" id="abstract" placeholder="Abstract">{{$articl->abstract}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
